...
import com.danielhs.cursomc.domain.PagamentoComBoleto;
import com.danielhs.cursomc.domain.PagamentoComCartao;
import com.danielhs.cursomc.domain.Pedido;
...
import com.danielhs.cursomc.repositories.EnderecoRepository;
import com.danielhs.cursomc.repositories.EstadoRepository;
import com.danielhs.cursomc.repositories.PagamentoRepository;
import com.danielhs.cursomc.repositories.PedidoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "3213213454", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll((Arrays.asList("99999999", "88888888")));
		Endereco e1 = new Endereco(null, "Rua Flores", "55", "Apt 303", "Jardim", "19807000", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida MAtos", "105", "Sala 800", "Centro", "19808000", cli1, c2);
